	  ...
	  <div class="span12">
				<div class="well">
					...
					<form action="back_office.php" method="post">
						...
						<?php 
						if(isset ($_POST['clientco2'])) { $clientco2 = $_POST['clientco2'];
					...
					<form action="back_office.php" method="post">
						...
						<input type="text" class="input-medium" name="codebouteille" required="required" placeholder="Code Bouteille">
						<input type="text" class="input-medium" name="fabricant" required="required" placeholder="Fabricant">
						<input type="text" class="input-medium" name="pressionepreuve" required="required" placeholder="Pression d'épreuve">
					...
					<form action="back_office.php" method="post">
						...
						<input type="text" class="input-medium" name="marquecommerciale" required="required" placeholder="Marque Commerciale">
						<input type="text" class="input-medium" name="numerocertification" required="required" placeholder="Numéro de Certification">
						<input type="submit" class="btn btn-success">
						<?php 
				...
				<div class="well">
					...
					<form action="back_office.php" method="post">
						...
						<input type="text" class="input-medium" name="pressionepreuvegaz" required="required" placeholder="Pression d'épreuve">
