    ...
    <div class="container">
      ...
      <h1>Rechercher dans la base de données</h1>
			...
			<p> Certificats extincteurs CO2 :<?php if(isset($_POST['dateenr'])) {
												...
												while ($donneesnumcertifext =  $numcertifext->fetch()) { ?>&nbsp;<?php echo $donneesnumcertifext['NumCertificat']; } }
												?>
			</p>
			<p> Certificats Bouteille ou Enceinte de gaz :<?php if(isset($_POST['dateenr'])) {
												...
												while ($donneesnumcertifgaz =  $numcertifgaz->fetch()) { ?>&nbsp;<?php echo $donneesnumcertifgaz['NumCertificat']; } }
												?>
			</p>
			</div>
            <div class="well">
			...
			<p> Certificats extincteurs CO2 :<?php if(isset($_POST['dateepr'])) {
												...
												while ($donneesnumcertifext2 =  $numcertifext2->fetch()) { ?>&nbsp;<?php echo $donneesnumcertifext2['NumCertificat']; } }
												?>
			</p>
			<p> Certificats Bouteille ou Enceinte de gaz :<?php if(isset($_POST['dateepr'])) {
												...
												while ($donneesnumcertifgaz2 =  $numcertifgaz2->fetch()) { ?>&nbsp;<?php echo $donneesnumcertifgaz2['NumCertificat']; } }
												?>
			</p>
			</div>
            <div class="well">
				...
				<p> Certificats extincteurs CO2 :<?php if(isset($_POST['numextincteur'])) {
												...
												$numcertifext3 = $bdd-> query("SELECT NumCertificat FROM certificat WHERE 
																															...
																															");
												while ($donneesnumcertifext3 =  $numcertifext3->fetch()) { ?>&nbsp;<?php echo $donneesnumcertifext3['NumCertificat']; } }
												?>
			</p>
			<form action="rechercher.php" method="post">
			...
			<p> Certificats Bouteille ou Enceinte de gaz :<?php if(isset($_POST['numbouteille'])) {
												...
												$numcertifgaz3 = $bdd-> query("SELECT NumCertificat FROM certificatgaz WHERE 
																															...
																															");
												while ($donneesnumcertifgaz3 =  $numcertifgaz3->fetch()) { ?>&nbsp;<?php echo $donneesnumcertifgaz3['NumCertificat']; } }
												?>
			</p>
            </div>
    </div>
