  ...
  <body>
    <div class="container">
	  ...
	  <div class="modal hide" id="codebouteille" aria-hidden="true" style="display: none;">
				...
				<div class="modal-body">
					<form action="recherchecodebouteille.php" method="post">
						...
						<select name="fournisseur">
							...
							?>
								<option value="<?php echo $donnees1['Fournisseur']; ?>"><?php echo $donnees1['Fournisseur']; ?></option>
								<?php } ?>
						</select>
						...
						<select name="pressionepreuve">
							...
							?>
							   <option value="<?php echo $donnees4['PressionEpreuve']; ?>"><?php echo $donnees4['PressionEpreuve']; ?></option>
							<?php } ?>
						</select>
						...
						<select name="filetage">
							...
							?>
							   <option value="<?php echo $donnees5['Filetage']; ?>"><?php echo $donnees5['Filetage']; ?></option>
							<?php } ?>
						</select>
						</div>
		...
		<div class="well">
            <input type="text" class="input-medium" name="nomsign" value="<?php echo $donneesnomsigna['NomSign'];?>" placeholder="Nom">
            <span class="help-inline">Nom du signataire</span> 
			<br>
            <input type="date" class="input-medium" name="dateenr" value="<?php echo $donneesdateenra['DateEnr'];?>" placeholder="jj/mm/aaaa">
            <span class="help-inline">Date Enregistrement</span> 
			<br>
            <input type="date" class="input-medium" name="dateepr" value="<?php echo $donneesdateepra['DateEpr'];?>" placeholder="jj/mm/aaaa">
			...
			<br>
              ...
              <select name="client">
							...
							?>
							   <option value="<?php echo $donneesclientco2['NomClient']; ?>"><?php echo $donneesclientco2['NomClient']; ?></option>
							<?php } ?>
								<option value="<?php echo $donneesclienta['NomClientCO2'];?>"  selected="selected"><?php echo $donneesclienta['NomClientCO2'];?></option>
              </select>
              ...
              <select name="codebouteille">
							...
							?>
							   <option value="<?php echo $donneescodebouteille['CodeBouteille']; ?>"><?php echo $donneescodebouteille['CodeBouteille']; ?></option>
							<?php } ?>
								 <option value="<?php echo $donneescodebouteillea['CodeBouteille'];?>"  selected="selected"><?php echo $donneescodebouteillea['CodeBouteille'];?></option>
              </select>
              ...
              <select name="certification">
							...
							?>
							   <option value="<?php echo $donneescertification['numeroCertification']; ?>"><?php echo $donneescertification['marqueCommerciale'],"&nbsp;",$donneescertification['numeroCertification']; ?></option>
							<?php } ?>
								<option value="<?php echo $donneescertificationa['Certification'];?>"  selected="selected"><?php echo $donneescertificationa['Certification'];?></option>
              </select>
			  <br>
			  <span class="help-inline">Pression de Service</span> 
			  <input type="text" class="input-medium" name="pressionservice" value="<?php echo $donneespressionServicea['pressionService'];?>" placeholder="Pression de service">
              <table name="tableau" class="table table-condensed table-striped table-bordered">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte1" value="<?php echo $donneesnumenceinte1a['numEnceinte1'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr1" value="<?php echo $donneesdatepremepr1a['anneePremEpr1'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr1" value="<?php echo $donneesdatedernepr1a['dateDernEpr1'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs1" value="<?php echo $donneesobs1a['obs1'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
				  <td>2</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte2" value="<?php echo $donneesnumenceinte2a['numEnceinte2'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr2" value="<?php echo $donneesdatepremepr2a['anneePremEpr2'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr2" value="<?php echo $donneesdatedernepr2a['dateDernEpr2'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs2" value="<?php echo $donneesobs2a['obs2'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>3</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte3" value="<?php echo $donneesnumenceinte3a['numEnceinte3'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr3" value="<?php echo $donneesdatepremepr3a['anneePremEpr3'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr3" value="<?php echo $donneesdatedernepr3a['dateDernEpr3'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs3" value="<?php echo $donneesobs3a['obs3'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>4</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte4" value="<?php echo $donneesnumenceinte4a['numEnceinte4'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr4" value="<?php echo $donneesdatepremepr4a['anneePremEpr4'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr4" value="<?php echo $donneesdatedernepr4a['dateDernEpr4'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs4" value="<?php echo $donneesobs4a['obs4'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>5</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte5" value="<?php echo $donneesnumenceinte5a['numEnceinte5'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr5" value="<?php echo $donneesdatepremepr5a['anneePremEpr5'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr5" value="<?php echo $donneesdatedernepr5a['dateDernEpr5'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs5" value="<?php echo $donneesobs5a['obs5'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>6</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte6" value="<?php echo $donneesnumenceinte6a['numEnceinte6'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr6" value="<?php echo $donneesdatepremepr6a['anneePremEpr6'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr6" value="<?php echo $donneesdatedernepr6a['dateDernEpr6'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs6" value="<?php echo $donneesobs6a['obs6'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>7</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte7" value="<?php echo $donneesnumenceinte7a['numEnceinte7'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr7" value="<?php echo $donneesdatepremepr7a['anneePremEpr7'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr7" value="<?php echo $donneesdatedernepr7a['dateDernEpr7'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs7" value="<?php echo $donneesobs7a['obs7'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>8</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte8" value="<?php echo $donneesnumenceinte8a['numEnceinte8'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr8" value="<?php echo $donneesdatepremepr8a['anneePremEpr8'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr8" value="<?php echo $donneesdatedernepr8a['dateDernEpr8'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs8" value="<?php echo $donneesobs8a['obs8'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>9</td>
                    <td> 
                      <input type="text" class="input-medium" name="numenceinte9" value="<?php echo $donneesnumenceinte9a['numEnceinte9'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr9" value="<?php echo $donneesdatepremepr9a['anneePremEpr9'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr9" value="<?php echo $donneesdatedernepr9a['dateDernEpr9'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs9" value="<?php echo $donneesobs9a['obs9'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>10</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte10" value="<?php echo $donneesnumenceinte10a['numEnceinte10'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr10" value="<?php echo $donneesdatepremepr10a['anneePremEpr10'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr10" value="<?php echo $donneesdatedernepr10a['dateDernEpr10'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs10" value="<?php echo $donneesobs10a['obs10'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>11</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte11" value="<?php echo $donneesnumenceinte11a['numEnceinte11'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr11" value="<?php echo $donneesdatepremepr11a['anneePremEpr11'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr11" value="<?php echo $donneesdatedernepr11a['dateDernEpr11'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs11" value="<?php echo $donneesobs11a['obs11'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>12</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte12" value="<?php echo $donneesnumenceinte12a['numEnceinte12'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr12" value="<?php echo $donneesdatepremepr12a['anneePremEpr12'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr12" value="<?php echo $donneesdatedernepr12a['dateDernEpr12'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs12" value="<?php echo $donneesobs12a['obs12'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>13</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte13" value="<?php echo $donneesnumenceinte13a['numEnceinte13'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr13" value="<?php echo $donneesdatepremepr13a['anneePremEpr13'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr13" value="<?php echo $donneesdatedernepr13a['dateDernEpr13'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs13" value="<?php echo $donneesobs13a['obs13'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>14</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte14" value="<?php echo $donneesnumenceinte14a['numEnceinte14'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr14" value="<?php echo $donneesdatepremepr14a['anneePremEpr14'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr14" value="<?php echo $donneesdatedernepr14a['dateDernEpr14'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs14" value="<?php echo $donneesobs14a['obs14'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>15</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte15" value="<?php echo $donneesnumenceinte15a['numEnceinte15'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr15" value="<?php echo $donneesdatepremepr15a['anneePremEpr15'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr15" value="<?php echo $donneesdatedernepr15a['dateDernEpr15'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs15" value="<?php echo $donneesobs15a['obs15'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>16</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte16" value="<?php echo $donneesnumenceinte16a['numEnceinte16'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr16" value="<?php echo $donneesdatepremepr16a['anneePremEpr16'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr16" value="<?php echo $donneesdatedernepr16a['dateDernEpr16'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs16" value="<?php echo $donneesobs16a['obs16'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>17</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte17" value="<?php echo $donneesnumenceinte17a['numEnceinte17'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr17" value="<?php echo $donneesdatepremepr17a['anneePremEpr17'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr17" value="<?php echo $donneesdatedernepr17a['dateDernEpr17'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs17" value="<?php echo $donneesobs17a['obs17'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>18</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte18" value="<?php echo $donneesnumenceinte18a['numEnceinte18'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr18" value="<?php echo $donneesdatepremepr18a['anneePremEpr18'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr18" value="<?php echo $donneesdatedernepr18a['dateDernEpr18'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs18" value="<?php echo $donneesobs18a['obs18'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>19</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte19" value="<?php echo $donneesnumenceinte19a['numEnceinte19'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr19" value="<?php echo $donneesdatepremepr19a['anneePremEpr19'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr19" value="<?php echo $donneesdatedernepr19a['dateDernEpr19'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs19" value="<?php echo $donneesobs19a['obs19'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				  <tr>
                    <td>20</td>
                   <td> 
                      <input type="text" class="input-medium" name="numenceinte20" value="<?php echo $donneesnumenceinte20a['numEnceinte20'];?>" placeholder="n°enceinte"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="4" name="datepremepr20" value="<?php echo $donneesdatepremepr20a['anneePremEpr20'];?>" placeholder="aaaa"> 
                    </td>
                    <td> 
                      <input type="text" class="input-medium" maxlength="7" name="datedernepr20" value="<?php echo $donneesdatedernepr20a['dateDernEpr20'];?>" placeholder="mm/aaaa"> 
                    </td>
                    <td>  
                      <input type="text" class="input-medium" name="obs20" value="<?php echo $donneesobs20a['obs20'];?>" placeholder="observation"> 
                    </td>
                  </tr>
				</tbody>
			</table>
				...
				<?php $dernnumcertif = $bdd-> query("SELECT MAX(NumCertificat) AS numcertifmax FROM certificat");
