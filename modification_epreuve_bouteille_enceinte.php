		...
		<div class="well">
			...
			<br>
              ...
              <select name="client">
							...
							<?php } ?>
								<option value="<?php echo $donneesclienta['NomClientGaz'];?>"  selected="selected"><?php echo $donneesclienta['NomClientGaz'];?></option>
              </select>
              ...
              <select name="codebouteille">
							...
							?>
							   <option value="<?php echo $donneescodebouteille['idEnceinte']; ?>"><?php echo $donneescodebouteille['idEnceinte']; ?></option>
							<?php } ?>
