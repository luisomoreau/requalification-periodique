...
$obs10 = $_POST['obs10'];
$enregistrement2 = $bdd->prepare("UPDATE certificattransportable
									SET NumCertificat = :numcertif,
										NomSign = :nomsign,
										DateEnr = :dateenr,
										DateEpr = :dateepr,
										NomClientTransportable = :client,
...
?>
<title>Modification Formulaire Impression Enceinte Transportable</title>
