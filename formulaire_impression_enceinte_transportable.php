...
$obs10 = $_POST['obs10'];
$enregistrement = $bdd->prepare('INSERT INTO certificattransportable
										(NumCertificat, 
										NomSign, 
										DateEnr, 
										DateEpr, 
										NomClientTransportable,
										pressionService,
										CodeBouteille,  
										numEnceinte1, 
										anneePremEpr1, 
...
?>
<title>Formulaire Impression Epreuve Bouteille Transportable</title>
...
<div class="row">
    <h4>
        <center>
            ARRETE DU 3 MAI 2004 MODIFIE<br>
            CERTIFICAT D'INSPECTION DE BOUTEILLES TRANSPORTABLES<br>
        </center>
    </h4>
    <p>
...
<div class="span11">
    <div class="well">
        ...
        <p> Nom du propriétaire exploitant / client : <strong><?php echo $_POST['client']; ?></strong></p>
        </p>
    </div>
</div>
<div class="span11">
...
<div class="span11">
    ...
    <div class="well">
        <p>N° de certificat : BT<?php echo $_POST['numcertif']; ?></p>
