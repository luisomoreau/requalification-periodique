...
<html>
  ...
  <head>
	...
	$obs10 = $_POST['obs10'];
	$enregistrement =$bdd->prepare('INSERT INTO certificatgaz
										(NumCertificat, 
										NomSign, 
										DateEnr, 
										DateEpr, 
										...
										:datedernepr10,
										:obs10)');
			$enregistrement->execute(array('numcertif'=>$numcertif,
										'nomsign'=>$nomsign,
										'dateenr'=>$dateenr,
										'dateepr'=>$dateepr,
										'client'=>$client,
...
function int2str($a){
  ...
  <body>
	...
	<div class="row">
		...
		<p>
			&nbsp;&nbsp;&nbsp;INSPECTION opérée le <?php echo date("d/m/y", strtotime($dateenr)); ?> par le responsable, <?php echo $_POST['nomsign']; ?>.
		</p>
		</div>
		<div class="span11">
			<div class="well">
				<p>Etablissement où l'inspection de requalification a été faite : <strong> LSI 1319 Rue de Vert Buisson 76160 St LEGER du BOURG DENIS</strong>
				</p>
				<p>Nom et adresse de la société qui a demandé la requalification périodique et qui est redevable des frais : <strong> LSI 1319 Rue de Vert Buisson 76160 St LEGER du BOURG DENIS</strong>
				</p>
		...
		<div class="span11">
				...
				Constructeur : <?php 
						...
						while ($donneesconstructeur =  $constructeur->fetch()) { echo $donneesconstructeur['Fournisseur']; }
						?>L | 
				Materiau : <?php 
				...
				Nature gaz : <?php 
						...
						while ($donneesgaz =  $gaz->fetch()) { echo $donneesgaz['Gaz']; }
						?> |
				Volume : <?php 
				...
				Longueur : <?php 
						...
						while ($donneeslongueur =  $longueur->fetch()) { echo $donneeslongueur['Longueur']; }
						?> mm |
				Diamètre : <?php 
						$diametre = $bdd-> query("SELECT Diametre FROM enceintegaz WHERE idEnceinte ='$codebouteille'");
						while ($donneesdiametre =  $diametre->fetch()) { echo $donneesdiametre['Diametre']; }
						?> mm
				</center></p>
		...
		<div class="span11">
				...
				L'inspection de requalification de la bouteille et de ses accessoires sous pression n'ont donné lieu à aucune observation défavorable empêchant la remise en service des équipements, sous réserve du succès de la requalification périodique.</p>
			<div class="well">	
